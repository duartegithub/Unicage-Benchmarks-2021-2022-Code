...
# Running command: ./verify-sort.sh <volume> <run> <system>
...
a=$1
hdfs_directory=/outputs/batch/sort/sort-$a"GB"-results
unicage_directory=~/datav/outputs/batch/sort/sort-$a"GB"-results
local_directory=~/datav/outputs/batch/sort/sort-$a"GB"-results/$2
benchmark_directory=~/implementation/benchmarks/benchmark-results/batch/sort/sort-$a"GB"
big_data_system=$3
